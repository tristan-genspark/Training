...
I created a TCP Probe to check port 80

I added the yaml content below to a text file 




I went to the amazon cloud shell to do this

I createed the file on my computer named tcp-liveness-readiness.yaml

Add the code from the "TCP liveness probe" section found here
https://kubernetes.io/docs/tasks/configure-pod-container/configure-liveness-readiness-startup-probes/
seen below


Upload the created file to the clouds shell enviornment
